		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="index.php" class="text-decoration-none">
					...
					<span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Dukann</span>
				</a>
			</div>
                ...
                @foreach (getCategories() as $category)
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                @if($category->image != "")
                                    <img src="{{asset('uploads/category/thumb/'.$category->image)}}" class="img-fluid">
                                @endif
                            </div>
                            <div class="right">
                                <div class="cat-data">
                        ...
                        </div> <!-- Closing cat-card div -->
                    </div> <!-- Closing col-lg-3 div -->
                @endforeach
            @endif
        </div> <!-- Closing row pb-3 div -->
