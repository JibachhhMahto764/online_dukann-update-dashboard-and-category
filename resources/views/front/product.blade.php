                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="col-md-12 mt-5">
                                ...
                                <div class="rating-group mb-4">
                                   <span> <strong>Jibachh Singh </strong></span>
                                    <div class="star-rating mt-2" title="70%">
                                        <div class="back-stars">
                                            <i class="fa fa-star" aria-hidden="true"></i>
                                            <i class="fa fa-star" aria-hidden="true"></i>
                                ...
                                <div class="rating-group mb-4">
                                    <span class="author"><strong>Jibachh Singh </strong></span>
            ...
            if (response.status == true){
                ...
                if (errors.name){
                   $("#name").addClass('is-invalid').siblings('p').html(errors.name).addClass
                    ...
                    $("#name").removeClass('is-invalid').siblings('p').html(errors.name).removeClass
                    ('invalid-feedback');
                }
                
                if (errors.email){
                   $("#email").addClass('is-invalid').siblings('p').html(errors.email).addClass
                     ('invalid-feedback');  
                }else{
                ...
                if (errors.comment){
                   $("#comment").addClass('is-invalid').siblings('p').html(errors.comment).addClass
                     ('invalid-feedback');  
                }else{
                    $("#comment").removeClass('is-invalid').siblings('p').html('').removeClass
                    ('invalid-feedback');
                }
