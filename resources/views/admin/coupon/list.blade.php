					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{route('coupons.create')}}" class="btn btn-primary">New DiscountCoupon</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
								...
								<table class="table table-hover text-nowrap">
									...
									<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ (!empty($DiscountCoupon->ends_at)) ? \Carbon\Carbon::parse($DiscountCoupon->ends_at)->format('Y/m/d H:i:s') : '' }}</td>
											<td>
