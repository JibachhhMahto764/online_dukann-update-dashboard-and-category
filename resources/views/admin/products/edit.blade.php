                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="slug" readonly name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ $product->slug }}">
                                                    <p class="error"></p>	
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <div class="custom-control custom-checkbox">
                                                         <!-- here i am using the input type hidden and the value no because the uncheck track quantity is not record  -->
            ...
            $.ajax({
                       ...
                       $("#category").change(function(){
                        var category_id = $(this).val();
                         $.ajax({
                            url: "{{route('product-subcategorie.index')}}", 
                            type: 'get',
